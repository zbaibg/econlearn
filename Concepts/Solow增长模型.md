...
为了让人均产出在长期保持正增长，需要让生产系统本身随时间变化。采用劳动增进型技术：
...
但普通人均资本和人均产出在[[平衡增长路径]]上满足：

$$
\boxed{g_k=g_y=g_A}
$$

也就是说：**在技术归一化坐标中是固定点，在普通人均坐标中却可以持续增长。**

若初始 $x_0<x^*$，还会出现额外的[[追赶增长]]。由于：
...
所以早期增长可以显著高于 $g_A$；随着 $x\to x^*$，资本追赶项 $g_x\to0$，长期只剩技术/生产率增长。

完整推导、数值模拟与中国增长的有限类比见 [[../Economics/技术进步与持续增长|技术进步与持续增长]]。
...
- [[有效劳动]] 把技术进步写成劳动效率的提高。
- [[平衡增长路径]] 把“长期增长”与“固定点”统一为不同坐标系中的同一动力系统。
- [[追赶增长]] 解释低资本经济为什么在过渡期可以增长得显著快于长期技术增长率。
